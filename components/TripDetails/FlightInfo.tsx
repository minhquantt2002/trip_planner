    ...
    >
      {flightData.map((flight: any, index: number) => (
        ...
        >
          ...
          <Text style={styles.flightText}>
            Departure: {flight.departure_city} at {flight.departure_time} on{' '}
            {moment(flight.departure_date).format('MMM Do, YYYY')}
          </Text>
          <Text style={styles.flightText}>
            Arrival: {flight.arrival_city} at {flight.arrival_time} on{' '}
            {moment(flight.arrival_date).format('MMM Do, YYYY')}
          </Text>
...
const handlePressFlight = (flight: any) => {
