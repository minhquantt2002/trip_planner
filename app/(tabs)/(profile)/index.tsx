    ...
    <SafeAreaView className="h-full bg-white">
      <ScrollView className="w-full">
        <View className="flex h-full w-full items-center">
          ...
          <View className="mx-4 mt-6 w-11/12 flex-row items-center rounded-lg bg-gray-200 pb-6 pl-4 pr-4 pt-6">
          ...
          <View className="mt-6 w-11/12">
            ...
            <TouchableOpacity className="mx-4 flex-row items-center justify-between border-b border-gray-200 py-4">
              <View className="flex-row items-center">
